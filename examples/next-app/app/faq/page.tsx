...
const faq = FAQPageBuilder({
  questions: [
    ...
    },
    {
      ...
      answer: "Yes! Schema Sentry is built specifically for Next.js App Router with a simple <Schema /> component that automatically injects JSON-LD into your pages."
    },
    {
