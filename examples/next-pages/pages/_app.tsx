...
export default function App({ Component, pageProps }: AppProps) {
  return (
    <>
      <Head>
        <title>Schema Sentry Pages Router Demo</title>
        <meta name="description" content="A comprehensive demo of Schema Sentry - type-safe structured data for Next.js Pages Router" />
      </Head>
      <div style={{
        margin: 0,
        ...
        <nav style={{
          ...
          <div style={{
            ...
            <Link href="/" style={{
              ...
              Schema Sentry Demo (Pages Router)
            </Link>
